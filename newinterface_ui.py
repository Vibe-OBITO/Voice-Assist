...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setObjectName("ZiZi^-^")
        MainWindow.resize(441, 656)
        font = QtGui.QFont()
        font.setPointSize(8)
        MainWindow.setFont(font)
        MainWindow.setStyleSheet("background-color: #E6E6FA;")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate('ZiZi^-^', "ZiZi^-^"))
        self.pushButton.setText(_translate("ZiZi^-^", "Слушать"))
        self.pushButton_2.setText(_translate("ZiZi^-^", "Стоп"))
        self.label.setText(_translate("ZiZi^-^", "Voice Assistant"))
